                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-100 bg-primary border border-primary-300 cursor-default leading-5 dark:bg-primary-800 dark:border-primary-600">{{ $page }}</span>
                                    </span>
                                @else
                                    <a href="{{ $url }}"
